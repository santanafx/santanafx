...
React, JavaScript, Next, TypeScript, Clean Code, Atomic Design, SOLID, GraphQL, API REST, Storybook, Docker, 
PostgreSQL, Git, GitHub, CSS, Styled-components, Material UI, HTML, Jest and Cypress. 
